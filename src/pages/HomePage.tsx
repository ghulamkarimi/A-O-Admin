      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <ul className="space-y-4">
          <li className="border-b pb-2">
            <p>
              <strong>Neues Angebot:</strong> BMW 5er wurde von Admin hinzugefügt.
            </p>
            <span className="text-sm text-gray-600">Vor 2 Stunden</span>
          </li>
          <li className="border-b pb-2">
            <p>
              <strong>Benutzerregistrierung:</strong> Ein neuer Benutzer "Max Mustermann" hat sich angemeldet.
            </p>
            <span className="text-sm text-gray-600">Vor 1 Tag</span>
          </li>
          <li className="border-b pb-2">
            <p>
